...
export default function ProductRowSection({
    ...
    const buildQueryString = () => {
        ...
        if (query.upperId) params.set("upperId", String(query.upperId));
        if (query.middleId) params.set("mid", String(query.middleId));
        if (query.lowId) params.set("low", String(query.lowId));
        params.set("page", "0");
