...
interface FilterBarProps {
    categoryName?: string;
    upperList?: { id?: number | string; name?: string; label?: string; upperCt?: string; upperIdx?: number | string }[];
    middleList?: { id?: number | string; name?: string; label?: string; middleCt?: string; middleIdx?: number | string; middleId?: number | string }[];
    lowList?: { id?: number | string; name?: string; label?: string; lowCt?: string; lowIdx?: number | string; lowId?: number | string }[];
    selected?: { mid?: number | string | null; low?: number | string | null };
    currentSort?: string;
    currentUpperId?: number | string | null;
}
...
export default function FilterBar({
    ...
    // 거래방식 적용
    const applyDealType = (code: string) => {
        const params = new URLSearchParams(searchParams.toString());
    ...
    // 링크 빌드
    const buildHrefForMid = (midId: number | string | null | undefined) => {
        const params = new URLSearchParams(searchParams.toString());
    ...
    const buildHrefForLow = (lowId: number | string | null | undefined) => {
        const params = new URLSearchParams(searchParams.toString());
    ...
    const buildHrefForUpper = (name: string | undefined) => `/category/${encodeURIComponent(name ?? "")}`;
