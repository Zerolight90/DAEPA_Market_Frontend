...
export default function ProductCard({ item, hrefBase = "/store" }: ProductCardProps) {
    const [fav, setFav] = useState(false);
    const [count, setCount] = useState(0);

    const rawSell =
        (item as unknown as Record<string, unknown>)?.dSell ??
        (item as unknown as Record<string, unknown>)?.d_sell ??
        (item as unknown as Record<string, unknown>)?.dsell ??
        (item as unknown as Record<string, unknown>)?.dStatus ??
        (item as unknown as Record<string, unknown>)?.d_status ??
        (item as unknown as Record<string, unknown>)?.dstatus ??
        (item as unknown as Record<string, unknown>)?.dealStatus ??
        0;
