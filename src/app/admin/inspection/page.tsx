                  ...
                  <>
                    ...
                    <div style={{
                      ...
                      <button
                        ...
                        onMouseLeave={(e) => {
                          (e.target as HTMLElement).style.backgroundColor = selectedInspection.result === "passed" ? "#f0fdf4" : "#ffffff";
                      ...
                      <button
                        ...
                        onMouseLeave={(e) => {
                          (e.target as HTMLElement).style.backgroundColor = selectedInspection.result === "failed" ? "#fef2f2" : "#ffffff";
