...
function JoinFormContent() {
    ...
    const api_url = "/api/sign/join/signup";

    // 중복확인 API
    const check_id = "/api/sign/join/check_id";
    const check_nickname = "/api/sign/join/check_nickname";
    const check_phone = "/api/sign/join/check_phone";
