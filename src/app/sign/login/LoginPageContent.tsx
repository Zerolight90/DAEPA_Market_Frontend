...
export default function LoginPageContent() {
    ...
    const submit = async (e) => {
        ...
        setSessionMsg("");
        try {
            const res = await api.post("/sign/login", { u_id: id, u_pw: pw, autoLogin: autoLogin });
            ...
            <div className={styles.card}>
                <form onSubmit={submit}>
                    ...
                    <div className={styles.links}>
                        <a className={styles.link} href="/sign/login/find_id">아이디 찾기</a>
                        <span className={styles.divider}>|</span>
                        <a className={styles.link} href="/sign/login/find_password">비밀번호 찾기</a>
                        <span className={styles.divider}>|</span>
                        <a className={styles.link} href="/sign/join/agree">회원가입</a>
                    </div>
