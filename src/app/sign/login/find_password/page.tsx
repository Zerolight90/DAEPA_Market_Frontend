...
export default function FindPasswordPage() {
    ...
    const handleFindPassword = async (e) => {
        ...
        try {
            const res = await axios.post("/api/sign/login/find_password", {
                u_id: uId,
                u_name: name,
                u_phone: phone,
            });
    ...
    const handleResetPassword = async () => {
        ...
        try {
            setStage("resetting");
            // 백엔드: PUT /api/sign/find_password/reset  body: { u_id, new_password }
            const res = await axios.put("/api/sign/login/find_password/reset", {
                u_id: uId,
                new_password: newPw,
            });
            ...
            <div className={styles.container}>
                <div className={styles.card}>
                    ...
                    <div className={styles.links}>
                        ...
                        <Link href="/sign/login/find_id" className={styles.link}>아이디 찾기</Link>
                    </div>
                </div>
            </div>
        );
