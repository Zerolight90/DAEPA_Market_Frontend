...
export default function EditCategoryPicker({
    ...
    const [middles, setMiddles] = useState<any[]>([]);
    const [lows, setLows] = useState<any[]>([]);

    const [upperSel, setUpperSel] = useState<any>(null);
    const [middleSel, setMiddleSel] = useState<any>(null);
    const [lowSel, setLowSel] = useState<any>(null);
